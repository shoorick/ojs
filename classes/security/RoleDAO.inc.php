...
class RoleDAO extends DAO {
	...
	*/
	...
	function &getUsersByRoleId($roleId = null, $journalId = null, $searchType = null, $search = null, $searchMatch = null, $dbResultRange = null, $sortBy = null, $sortDirection = SORT_DIRECTION_ASC) {
		...
		$searchTypeMap = array(
			USER_FIELD_FIRSTNAME => 'u.first_name', // FIXME Should be localized
	...
	function &getUsersByJournalId($journalId, $searchType = null, $search = null, $searchMatch = null, $dbResultRange = null, $sortBy = null, $sortDirection = SORT_DIRECTION_ASC) {
		...
		elseif (!empty($search))
			...
			case USER_FIELD_USERID:
				...
				break;
			case USER_FIELD_INITIAL:
				$searchSql = 'AND LOWER(u.last_name) LIKE LOWER(?)'; // FIXME Should be localized
				$paramArray[] = $search . '%';
				break;
		}
	...
	function deleteRoleByUserId($userId, $journalId  = null, $roleId = null) {
		return $this->update(
			...
			isset($journalId) && isset($roleId)
				?	array((int) $userId, (int) $journalId, (int) $roleId)
				: (isset($journalId)
					? array((int) $userId, (int) $journalId)
					: (isset($roleId)
						? array((int) $userId, (int) $roleId)
						: (int) $userId
					)
				)
		);
	 ...
	 * @return string
	 */
	// FIXME What about languages which have more than two numbers?
